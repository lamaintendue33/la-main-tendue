...
export const metadata: Metadata = {
  ...
  description: `${SITE.slogan} — Association d'aide alimentaire à Eysines (33320), en Gironde. Distribution hebdomadaire de colis à plus de 400 personnes depuis 1995.`,
  keywords: [
